...
new Sprite()
    ...
    s_text = {
        FlappyWizard: new Sprite(img, 59, 114, 96, 22),
        GameOver:   new Sprite(img, 59, 135, 94, 19),
        GetReady:   new Sprite(img, 59, 155, 87, 21)
    }
    s_buttons = {
        ...
        Restart:    new Sprite(img, 119, 191, 40, 14),
        Start: new Sprite(img, 159, 191, 40, 14)
    }

    s_score  = new Sprite(img, 138,  56, 113, 58);
    s_splash = new Sprite(img,   0, 114,  58, 49);
